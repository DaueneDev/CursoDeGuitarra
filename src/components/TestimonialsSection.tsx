...
export const TestimonialsSection = () => {
  const testimonials = [{
    content: "Tentei aprender a tocar guitarra sozinho durante muito tempo mas tive pouco progresso. Depois de apenas 3 meses com o curso, estou tocando músicas que nunca pensei que conseguiria. Muito obrigado!",
    author: 'Jorge Silva',
    age: '34',
