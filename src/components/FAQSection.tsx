...
export const FAQSection = () => {
  const faqs = [{
    ...
    answer: "Não é obrigatório! Mesmo sem guitarra, você pode começar a assistir, aprender a teoria e se preparar. Assim, quando tiver o instrumento, estará à frente!"
  }, {
    ...
    answer: 'O curso custa normalmente 1997 MT, mas está com preço promocional de apenas 249 MT por tempo limitado. É um pagamento único com acesso vitalício.'
  }, {
